...
Extract data from a SAM file and generate a BED file (using only basic Python commands)
Added by Andreas:
Define a function main that contains the code and is run at the end.
Introduce log file properly. I think it's going to append that file each time
